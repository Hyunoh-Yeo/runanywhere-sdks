...
extension CppBridge {
    ...
    public enum ToolCalling {
        ...
        public static func formatToolsForPrompt(
            ...
            defer { if let pointer = promptPtr { rac_free(pointer) } }
        ...
        public static func normalizeJson(_ jsonStr: String) -> String {
            ...
            defer { if let pointer = normalizedPtr { rac_free(pointer) } }
        ...
        // swiftlint:disable avoid_any_type prefer_concrete_types
    ...
    // swiftlint:enable avoid_any_type prefer_concrete_types
}
